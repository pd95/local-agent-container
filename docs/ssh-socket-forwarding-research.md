...
Authenticated HTTP MCP servers reachable from macOS are implemented as a
separate [Phase 4](managed-mcp-http-upstreams.md), not an expansion of the
completed Phase 3 stdio authority model.
